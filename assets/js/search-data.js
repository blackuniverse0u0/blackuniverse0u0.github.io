    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-gremsy-box",
          title: 'Gremsy Box',
          description: "PTZ camera and gimbal control system with web interface and AI tracking",
          section: "Projects",handler: () => {
              window.location.href = "/projects/gremsy_box/";
            },},{id: "projects-physics-to-robot-locomotion",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/locomotion_rl/";
            },},{id: "projects-sidewalker",
          title: 'SideWalker',
          description: "Autonomous robot navigation for urban sidewalks with Imitation and Reinforcement Learning",
          section: "Projects",handler: () => {
              window.location.href = "/projects/sidewalker/";
            },},{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
